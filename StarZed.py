...
print(Fore.LIGHTRED_EX + f'Пользуясь ботом, вы автоматически принимаете {Fore.RED}"Пользовательское соглашение"')
sleep(5)
...
print(Fore.LIGHTCYAN_EX + f''' 
 ...
 {Fore.LIGHTCYAN_EX} ████{Fore.LIGHTCYAN_EX}┃╚═╗ │ ├─┤├┬┘╔═╝├┤  ││┃█{Fore.LIGHTCYAN_EX}
 {Fore.LIGHTCYAN_EX} █{Fore.LIGHTCYAN_EX}┏┅┅┛╚═╝ ┴ ┴ ┴┴└─╚═╝└─┘─┴┘┃█{Fore.LIGHTCYAN_EX}                     
  {Fore.LIGHTCYAN_EX}█{Fore.LIGHTCYAN_EX}┊Version: 1.0 RELEASE    ┃█{Fore.LIGHTCYAN_EX} 
  {Fore.CYAN}█{Fore.LIGHTCYAN_EX}┊Telgram: @starzedscripts┃█{Fore.LIGHTCYAN_EX} 
 {Fore.CYAN} █{Fore.LIGHTCYAN_EX}┊Made by StarZed┎━━━━━━━━┛█{Fore.LIGHTCYAN_EX}
...
async def bombs(app, message):
    ...
    global number
    number = number + 1
    await message.edit_text("<b> ⭐️ @starzedscripts</b>")
...
def help(app, message):
    global number
    if message.from_user.id in {nex_id, just_id, drax_id}:
        app.send_message(message.chat.id, f'''
💾<b> Профиль:\n
